...
class CorrigeVerbeRemplirEntier extends ModeleCorrige {
  final String question;
  final String personne;
  final String bonneReponse;
  final String formeRepondue;

  CorrigeVerbeRemplirEntier(
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Text(
                      "Vous avez répondu \"${"${Verbe.correctionPersonnes(personne)} $formeRepondue"}\"",
          ...
          child: Column(children: [
            ...
            Row(
              children: [
                const Icon(Icons.arrow_forward),
                Text(
                    "$txtIlFallaitRepondre \"${"${Verbe.correctionPersonnes(personne)} $bonneReponse"}\"",
                    style: textStyleGeneral),
              ],
            )
          ]));
